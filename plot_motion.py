...
point_fig.xlabel('Linux Time (s)')
point_fig.ylabel('Center Point Horizontal Coordinate (pixels)')
point_fig.title('Motion Velocity')
point_fig.colorbar(label='State', ticks=[0, 1, 2, 3])
